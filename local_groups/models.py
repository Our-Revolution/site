...
class Group(models.Model):    
    ...
    other_types_of_organizing = models.TextField(null=True, blank=True, verbose_name="Other Types of Organizing", max_length=500)
    
    description = models.TextField(null=True, blank=False, max_length=1000, verbose_name="Description (1000 characters or less)")
