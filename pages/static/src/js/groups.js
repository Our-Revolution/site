  ...
  function updateInfo(groups) {
    ...
    if(groups.length != 0){
      ...
      $('.groups-map-info__status').append('\
        ...
        <a href="' + ourrevolution_start_group_url + '" class="btn btn-block btn-success uppercase ls2" target="_blank" onclick="trackOutboundLink(\'' + ourrevolution_start_group_url + '\', true)">Start a group</a>\
