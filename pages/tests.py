...
class RoutesTestCase(TestCase):
    ...
    def test_initiatives_alabama_amendment_8(self):
      response = self.client.get('/initiatives/alabama-amendment-8/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_alaska_measure_1(self):
      response = self.client.get('/initiatives/alaska-measure-1/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_arkansas_issue_7(self):
      response = self.client.get('/initiatives/arkansas-issue-7/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_california_prop_58(self):
      response = self.client.get('/initiatives/california-prop-58/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_california_prop_59(self):
      response = self.client.get('/initiatives/california-prop-59/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_california_prop_61(self):
      response = self.client.get('/initiatives/california-prop-61/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_california_prop_62(self):
      response = self.client.get('/initiatives/california-prop-62/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_california_prop_64(self):
      response = self.client.get('/initiatives/california-prop-64/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_california_prop_66(self):
      response = self.client.get('/initiatives/california-prop-66/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_california_prop_67(self):
      response = self.client.get('/initiatives/california-prop-67/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_colorado_amendment_69(self):
      response = self.client.get('/initiatives/colorado-amendment-69/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_florida_amendment_2(self):
      response = self.client.get('/initiatives/florida-amendment-2/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_louisiana_amendment_2(self):
      response = self.client.get('/initiatives/louisiana-amendment-2/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_maine_question_1(self):
      response = self.client.get('/initiatives/maine-question-1/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_maine_question_4(self):
      response = self.client.get('/initiatives/maine-question-4/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_maine_question_5(self):
      response = self.client.get('/initiatives/maine-question-5/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_maryland_citizens_election_fund(self):
      response = self.client.get('/initiatives/maryland-citizens-election-fund/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_massachusetts_measure_2(self):
      response = self.client.get('/initiatives/massachusetts-measure-2/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_missouri_amendment_6(self):
      response = self.client.get('/initiatives/missouri-amendment-6/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_montana_initiative_177(self):
      response = self.client.get('/initiatives/montana-initiative-177/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_montana_initiative_182(self):
      response = self.client.get('/initiatives/montana-initiative-182/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_nebraska_bill_268(self):
      response = self.client.get('/initiatives/nebraska-bill-268/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_nevada_question_2(self):
      response = self.client.get('/initiatives/nevada-question-2/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_oklahoma_question_776(self):
      response = self.client.get('/initiatives/oklahoma-question-776/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_oregon_measure_97(self):
      response = self.client.get('/initiatives/oregon-measure-97/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_oregon_measure_98(self):
      response = self.client.get('/initiatives/oregon-measure-98/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_south_dakota_amendment_t(self):
      response = self.client.get('/initiatives/south-dakota-amendment-t/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_south_dakota_law_20(self):
      response = self.client.get('/initiatives/south-dakota-law-20/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_south_dakota_measure_22(self):
      response = self.client.get('/initiatives/south-dakota-measure-22/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_virginia_right_to_work(self):
      response = self.client.get('/initiatives/virginia-right-to-work/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_washington_initiative_1433(self):
      response = self.client.get('/initiatives/washington-initiative-1433/')
      self.assertEqual(response.status_code, 200)
    
    def test_initiatives_washington_initiative_735(self):
      response = self.client.get('/initiatives/washington-initiative-735/')
      self.assertEqual(response.status_code, 200)
    ...
    def test_josh_fox_and_our_revolution_team_up(self):
      response = self.client.get('/josh-fox-and-our-revolution-team-up/')
      self.assertEqual(response.status_code, 200)
    
    def test_our_revolution_announces_final_round_of_endorsements(self):
      response = self.client.get('/our-revolution-announces-final-round-of-endorsements/')
      self.assertEqual(response.status_code, 200)
    
    def test_our_revolution_announces_formation_of_board(self):
      response = self.client.get('/our-revolution-announces-formation-of-board/')
      self.assertEqual(response.status_code, 200)
    
    def test_our_revolution_announces_latest_round_of_endorsements(self):
      response = self.client.get('/our-revolution-announces-latest-round-of-endorsements/')
      self.assertEqual(response.status_code, 200)
    
    def test_our_revolution_announces_more_endorsements(self):
      response = self.client.get('/our-revolution-announces-more-endorsements/')
      self.assertEqual(response.status_code, 200)
    
    def test_our_revolution_announces_next_round_of_endorsements(self):
      response = self.client.get('/our-revolution-announces-next-round-of-endorsements/')
      self.assertEqual(response.status_code, 200)
    
    def test_our_revolution_announces_second_round_of_endorsements(self):
      response = self.client.get('/our-revolution-announces-second-round-of-endorsements/')
      self.assertEqual(response.status_code, 200)
    
    def test_our_revolution_on_ma_primary_wins(self):
      response = self.client.get('/our-revolution-on-ma-primary-wins/')
      self.assertEqual(response.status_code, 200)
    
    def test_our_revolution_reacts_final_presidential_debate(self):
      response = self.client.get('/our-revolution-reacts-final-presidential-debate/')
      self.assertEqual(response.status_code, 200)
    
    def test_our_revolution_statement_on_ri_and_ny(self):
      response = self.client.get('/our-revolution-statement-on-ri-and-ny/')
      self.assertEqual(response.status_code, 200)
    
    def test_our_revolution_statement_on_shailene_woodley_arrest(self):
      response = self.client.get('/our-revolution-statement-on-shailene-woodley-arrest/')
      self.assertEqual(response.status_code, 200)
    
    def test_our_revolution_statement_on_shootings(self):
      response = self.client.get('/our-revolution-statement-on-shootings/')
      self.assertEqual(response.status_code, 200)
    
    def test_our_revolution_substantive_discussion(self):
      response = self.client.get('/our-revolution-substantive-discussion/')
      self.assertEqual(response.status_code, 200)
