...
class Questionnaire(models.Model):
    ...
    def __unicode__(self):
        if self.application_set:
            return self.application_set.first().candidate_first_name + ' ' + self.application_set.first().candidate_last_name + ' - ' + str(self.application_set.first().group) + ' Questionnaire'
        else:
