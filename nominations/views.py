...
class ApplicationExportView(UpdateView):
    ...
    def form_valid(self, form):
        ...
        # generate PDF
        pdf_template = 'admin/application_pdf.html'
        context = super(ApplicationExportView, self).get_context_data()
        return render_to_pdf(pdf_template, context)
...
# class ExportApplicationPDFView(PDFTemplateView):
#     template_name = 'admin/application_pdf.html'
#
#     def get_context_data(self, **kwargs):
#         return super(ExportApplicationPDFView, self).get_context_data(
#             pagesize='A4',
#             title='Hi there!',
#             **kwargs
#         )
